  ...
  <div class="py-4">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
      ...
      <nav class="flex gap-2">
        ...
        <RouterLink
          to="/admin/products"
          class="px-4 py-2 rounded-md text-sm font-medium bg-slate-100 text-slate-600 hover:bg-slate-200 transition-colors"
          >Products</RouterLink
        >
        <RouterLink
          to="/admin/orders"
    ...
    >
      <div
        class="w-8 h-8 border-4 border-indigo-200 border-t-indigo-600 rounded-full animate-spin mb-4"
      ></div>
    ...
    <template v-else-if="stats">
      ...
      <div class="mb-8">
        ...
        <div class="flex gap-3">
          ...
          >
          <RouterLink to="/admin/orders" class="btn-outline"
            >📋 Manage Orders</RouterLink
          >
        </div>
      </div>
        ...
        <table class="w-full">
          <thead>
            <tr class="bg-slate-50">
              <th
                class="text-left text-xs font-medium text-slate-500 uppercase tracking-wide px-3 py-2"
              >
                Order ID
              </th>
              <th
